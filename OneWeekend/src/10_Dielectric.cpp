...
#include "../public/Object/hittable.h"
...
int main() {
    ...
    world.add(make_shared<sphere>(vec3(-1,0,-1), 0.5, make_shared<dielectric>(1.2)));
    world.add(make_shared<sphere>(vec3(-1,1,-2), 1, make_shared<metal>(vec3(0.8, 0.8, 0.8))));
    world.add(make_shared<sphere>(vec3(1,1,-2), 1, make_shared<metal>(vec3(0.8, 0.8, 0.8))));
